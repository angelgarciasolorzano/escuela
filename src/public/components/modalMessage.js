class modalMessage extends HTMLElement {
    ...
    render() {
        this.shadowRoot.innerHTML = `
          <div class="modal fade" style="display: none;" tabindex="-1" id="modalMessage" data-bs-backdrop="static" aria-hidden="true">
      ...
      <div class="modal-footer border border-secondary" style="background-color:  #5dade2">
            ...
            <button type="button" class="btn btn-primary mx-auto w-30px" data-bs-dismiss="modal"
              id="btn-aceptar-modalMessage">Aceptar</button>
          </div>
          </div>
        </div>
      </div>`;
    ...
    _updateTitle(title) {
      const titleElement = this.shadowRoot.querySelector('#modalTitle');
      if (titleElement) {
